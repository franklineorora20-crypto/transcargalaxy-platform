  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 font-sans text-slate-900 selection:bg-amber-500 selection:text-slate-950">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-xl hover:bg-green-600 transition-all hover:scale-110 border-2 border-white group"
      ...
      >
        ...
        <span className="absolute right-16 bg-black text-white text-xs font-bold px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
          Join WhatsApp Group
        </span>
      </a>
    </div>
