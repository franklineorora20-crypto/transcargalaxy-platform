...
export const INITIAL_VEHICLES: Vehicle[] = [
  { id: 'veh-1', registrationNumber: 'KDE 416Q', model: 'Toyota HiAce 11-Seater', type: 'STANDARD_COACH', seatingCapacity: 11, status: 'AVAILABLE', currentLocation: 'Rongai', insuranceExpiry: '2026-12-31', inspectionExpiry: '2026-12-31', lastServiceDate: '2026-08-01', mileageKm: 150000, amenities: ['AC', 'USB Charging', 'Reclining Seats'], imageUrl: '/images/transcar_highway_kde4160.webp' },
  { id: 'veh-2', registrationNumber: 'KDF 520M', model: 'Toyota HiAce 11-Seater', type: 'STANDARD_COACH', seatingCapacity: 11, status: 'AVAILABLE', currentLocation: 'Kisii', insuranceExpiry: '2026-12-31', inspectionExpiry: '2026-12-31', lastServiceDate: '2026-08-01', mileageKm: 140000, amenities: ['AC', 'USB Charging', 'Reclining Seats'], imageUrl: '/images/transcar_highway_kde4160.webp' },
  { id: 'veh-3', registrationNumber: 'KDV 149E', model: 'Toyota HiAce 14-Seater', type: 'STANDARD_COACH', seatingCapacity: 14, status: 'AVAILABLE', currentLocation: 'Rongai', insuranceExpiry: '2026-12-31', inspectionExpiry: '2026-12-31', lastServiceDate: '2026-08-01', mileageKm: 155000, amenities: ['AC', 'USB Charging', 'Reclining Seats'], imageUrl: '/images/transcar_stalker_kdv149e.webp' },
...
export const INITIAL_TRIPS: Trip[] = [
  {
    ...
    departureTime: '2026-09-25T04:00:00.000Z',
    estimatedArrivalTime: '2026-09-25T10:30:00.000Z',
    fareKsh: 1600,
    status: 'SCHEDULED',
    delayMinutes: 0,
    totalSeats: 11,
  ...
  },
  {
    ...
    driverId: 'drv-frankline',
    driverName: 'Frankline Orora',
    departureTime: '2026-09-25T07:00:00.000Z',
    estimatedArrivalTime: '2026-09-25T13:30:00.000Z',
    fareKsh: 1600,
    status: 'SCHEDULED',
    delayMinutes: 0,
    totalSeats: 14,
    availableSeats: 7,
    bookedSeatNumbers: ['P1', '1A', '1B', '2A', '3A', '4A', '4B'],
  ...
  },
  {
    ...
    driverId: 'drv-frankline',
    driverName: 'Frankline Orora',
    departureTime: '2026-09-25T09:00:00.000Z',
    estimatedArrivalTime: '2026-09-25T16:00:00.000Z',
    fareKsh: 1600,
    status: 'IN_TRANSIT',
    currentStop: 'Narok',
    delayMinutes: 0,
    totalSeats: 14,
    availableSeats: 4,
    bookedSeatNumbers: ['P1', 'P2', '1A', '1B', '2A', '2B', '3A', '4A', '4B', '4C'],
  ...
  },
  {
    ...
    estimatedArrivalTime: '2026-09-25T17:45:00.000Z',
    fareKsh: 1700,
    status: 'BOARDING',
    delayMinutes: 0,
    totalSeats: 16,
...
export const INITIAL_BOOKINGS: Booking[] = [
  {
    ...
    contactName: 'Frankline Orora',
    contactPhone: '+254 724 626199',
    contactEmail: 'franklineorora20@gmail.com',
    emergencyContactName: 'Frankline Orora',
    emergencyContactPhone: '+254 717 747626',
    passengers: [
      { fullName: 'Frankline Orora', idNumber: '28941029', seatNumber: '1A', seatClass: 'STANDARD', fareKsh: 1500, hasBoarded: true, boardedAt: '2026-09-17T05:50:00.000Z' },
      { fullName: 'Frankline Orora', idNumber: '24890123', seatNumber: '1B', seatClass: 'STANDARD', fareKsh: 1500, hasBoarded: true, boardedAt: '2026-09-17T05:51:00.000Z' },
    ],
    totalFareKsh: 3000,
  ...
  },
  {
    ...
    emergencyContactPhone: '+254 717 747626',
    passengers: [
      { fullName: 'Frankline Orora', idNumber: '31890241', seatNumber: '2A', seatClass: 'STANDARD', fareKsh: 1500, hasBoarded: true, boardedAt: '2026-09-17T05:55:00.000Z' },
    ],
    totalFareKsh: 1500,
    bookingStatus: 'CHECKED_IN',
    paymentStatus: 'PAID',
  ...
  },
  {
    ...
    emergencyContactPhone: '+254 717 747626',
    passengers: [
      { fullName: 'Frankline Orora', idNumber: '29810452', seatNumber: '1A', seatClass: 'STANDARD', fareKsh: 1500, hasBoarded: false },
    ],
    totalFareKsh: 1500,
...
export const INITIAL_EXPENSES: ExpenseItem[] = [
  ...
  { id: 'exp-3', date: '2026-09-13', category: 'FUEL', amountKsh: 22000, vehicleRegistration: 'KDE 832Y', recipient: 'TotalEnergies Nakuru Hub', receiptNumber: 'TOT-48201', notes: 'Diesel replenishment 125 litres', approvedBy: 'Director Frankline Orora' },
  { id: 'exp-4', date: '2026-09-11', category: 'VEHICLE_MAINTENANCE', amountKsh: 15000, vehicleRegistration: 'KDH 345E', recipient: 'TransCar Rongai Service Bay', receiptNumber: 'SCA-88912', notes: 'Brake pads replacement & wheel alignment', approvedBy: 'Director Frankline Orora' },
  { id: 'exp-5', date: '2026-09-08', category: 'INSURANCE_LICENSING', amountKsh: 45000, vehicleRegistration: 'KDV 149E', recipient: 'Britam General Insurance / NTSA PSV', receiptNumber: 'NTSA-55109', notes: 'Annual Comprehensive PSV Fleet Insurance Renewal', approvedBy: 'Director Frankline Orora' },
...
export const INITIAL_PAYROLL: PayrollItem[] = [
  { id: 'pay-1', employeeName: 'Frankline Orora', employeeId: 'EMP-DRV-01', role: 'SENIOR_DRIVER', baseSalaryKsh: 75000, allowancesKsh: 15000, deductionsKsh: 8500, netPayKsh: 81500, paymentStatus: 'PAID', payPeriod: 'August 2026', paymentDate: '2026-08-30' },
  { id: 'pay-2', employeeName: 'Frankline Orora', employeeId: 'EMP-DRV-02', role: 'EXPRESS_DRIVER', baseSalaryKsh: 68000, allowancesKsh: 12000, deductionsKsh: 7800, netPayKsh: 72200, paymentStatus: 'PAID', payPeriod: 'August 2026', paymentDate: '2026-08-30' },
  { id: 'pay-3', employeeName: 'Frankline Orora', employeeId: 'EMP-DRV-03', role: 'SENIOR_DRIVER', baseSalaryKsh: 75000, allowancesKsh: 16000, deductionsKsh: 8500, netPayKsh: 82500, paymentStatus: 'PAID', payPeriod: 'August 2026', paymentDate: '2026-08-30' },
  { id: 'pay-4', employeeName: 'Frankline Orora', employeeId: 'EMP-MCH-01', role: 'MECHANIC', baseSalaryKsh: 60000, allowancesKsh: 8000, deductionsKsh: 6500, netPayKsh: 61500, paymentStatus: 'PAID', payPeriod: 'August 2026', paymentDate: '2026-08-30' },
  { id: 'pay-5', employeeName: 'Frankline Orora', employeeId: 'EMP-STA-01', role: 'STATION_AGENT', baseSalaryKsh: 50000, allowancesKsh: 6000, deductionsKsh: 5200, netPayKsh: 50800, paymentStatus: 'PAID', payPeriod: 'August 2026', paymentDate: '2026-08-30' },
];
